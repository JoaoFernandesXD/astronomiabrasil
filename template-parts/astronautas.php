...
/**
 * Template Name: Lista Astronautas
 */
...
<div class="search-container">
  <div class="search-box">
    <div>
      <input type="text" placeholder="Nome do Astronauta">
    </div>
    <div>
      <select>
        ...
        <option value="lost-in-service">LOST IN SERVICE</option>
        <option value="retired">RETIRED</option>
        <option value="deceased">DECEASED</option>
      </select>
    </div>
    <div>
      <input type="text" placeholder="Filtrar por Nacionalidade">
    </div>
    <div>
...
<div class="list-astronaut">
<div class="astronaut-container">

<div class="astronaut-header">
  <div class="astronaut-photo" style="background-image: url('https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/astronaut_images/thomas2520pesquet_image_20200102120546.jpeg');"></div>
  <div class="astronaut-info">
    <div class="astronaut-name">Thomas Pesquet</div>
    <div>
      <span class="icon"></span> <!-- Verde para ativo -->
      Ativo
    </div>
    <div>
      <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
        ...
        </svg></span> <!-- Globo para nacionalidade -->
      Francês
    </div>
    <div>
      <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-fill" viewBox="0 0 16 16">
        ...
        </svg></span> <!-- Escudo para governamental -->
    ...
    <div>
      <span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
        ...
        </svg></span> <!-- Satélite para não no espaço -->
      Terra
    </div>
  </div>
</div>
<div class="social-icons">
  <a href="https://facebook.com" target="_blank">
    <svg class="social-icon" role="img"  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
     
          <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
       
    </svg>
  </a>
  <a href="https://twitter.com/Thom_astro" target="_blank">
    <svg class="social-icon" role="img" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
          <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"/>
    
    </svg>
  </a>
  <a href="https://en.wikipedia.org/wiki/Thomas_Pesquet" target="_blank">
    <svg class="social-icon" role="img" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wikipedia" viewBox="0 0 16 16">
...
<div class="astronaut-bio">
  Thomas Gautier Pesquet é um engenheiro aeroespacial francês, piloto e astronauta da Agência Espacial Europeia. Pesquet foi selecionado pela ESA como candidato em maio de 2009 e concluiu com sucesso a sua formação básica em novembro de 2010. De novembro de 2016 a junho de 2017, Pesquet fez parte das Expedições 50 e 51 na Estação Espacial Internacional como engenheiro de voo.
</div>
...
<div class="astronaut-header">
  <div class="astronaut-photo" style="background-image: url('https://spacelaunchnow-prod-east.nyc3.digitaloceanspaces.com/media/astronaut_images/claude2520nicollier_image_20181127203218.jpg');"></div>
  <div class="astronaut-info">
    <div class="astronaut-name">Claude Nicollier</div>
    <div>
      <span class="icon"></span> <!-- Verde para ativo -->
      Aposentado
    </div>
